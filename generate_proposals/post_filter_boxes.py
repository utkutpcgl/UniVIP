        ...
        if max_iou_thr:
            if len(proposal):
                ...
                if iou_max > max_iou_thr:
                    continue
    return proposal # [[x,y,w,h], [x,y,w,h], [x,y,w,h] ...]
...
def filter_proposals_single(boxes_per_image_list):
    ...
    filtered_boxes_64_single = box_filter(boxes=boxes_per_image_list, min_size=64, max_ratio=3, max_iou_thr=0.5)
    filtered_boxes_96_single = box_filter(boxes=boxes_per_image_list, min_size=96, max_ratio=3, max_iou_thr=0.5)
